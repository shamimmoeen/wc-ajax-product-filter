...
const AddNewModal = _ref => {
  ...
  const formSubmissionDisabled = () => {
    if ((0,_utils__WEBPACK_IMPORTED_MODULE_4__.foundProVersion)()) {
      return false;
    }
  ...
  const modalContent = () => {
    if (loading) {
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, formSubmissionDisabled() && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ProFeaturesNotice__WEBPACK_IMPORTED_MODULE_9__["default"], {
        message: proMessage
...
/* harmony import */ var _TippyTooltip__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../TippyTooltip */ "./src/components/TippyTooltip.js");
...
const Table = _ref => {
  ...
  const tableHeader = () => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("tr", null, headers.map(item => {
      const id = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.slugify)(item);
  ...
  const tableBody = () => forms.map(_form => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("tr", {
    ...
    }, WCAPF_PRO ? form.locations : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Product archive pages', 'wc-ajax-product-filter')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("td", {
      className: "__Actions"
      ...
      disabled: isDeleting,
      isSmall: true
    }), WCAPF_PRO && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
...
function prepareFormData(raw) {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_1__.merge)(raw, {
    shortcode,
    editLink
  });
}
...
const PublishModal = _ref => {
  ...
  const getTabContent = tab => {
    ...
    if ('shortcode' === tab) {
      ...
      description = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Go to the widgets page, add <b>%s</b> widget to the desired area.', 'wc-ajax-product-filter'), widgetName);
    }
...
const useListTable = (dispatch, items, postType) => {
  ...
  const [publishModalOpen, setPublishModalOpen] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FILTER_KEY_IN_USE_MESSAGE": function() { return /* binding */ FILTER_KEY_IN_USE_MESSAGE; },
/* harmony export */   "GENERIC_ERROR_MESSAGE": function() { return /* binding */ GENERIC_ERROR_MESSAGE; },
...
const GENERIC_ERROR_MESSAGE = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Please fix the errors below.', 'wc-ajax-product-filter');
const FILTER_KEY_IN_USE_MESSAGE = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Filter key is in use by another entity.', 'wc-ajax-product-filter');
...
function mergeSelectOptions(freeOptions, proOptions) {
  ...
  if (withPro && !foundProVersion()) {
    ...
    options = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.concat)(freeOptions, [{
      proGroup: true,
      options: _proOptions
    }]);
  } else {
    options = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.concat)(freeOptions, proOptions);
  }
...
/* harmony export */   "filterModeOptions": function() { return /* binding */ filterModeOptions; },
/* harmony export */   "formLayoutOptions": function() { return /* binding */ formLayoutOptions; },
/* harmony export */   "formVisibilityOptions": function() { return /* binding */ formVisibilityOptions; },
/* harmony export */   "proVisibilityOptions": function() { return /* binding */ proVisibilityOptions; }
/* harmony export */ });
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__);
...
function formLayoutOptions() {
  return [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Vertical', 'wc-ajax-product-filter'),
    value: 'vertical'
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Horizontal', 'wc-ajax-product-filter'),
    value: 'horizontal',
    isPro: true
  }];
}
function filterModeOptions() {
  return [{
...
const proVisibilityOptions = [{
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Slide-out panel on desktop', 'wc-ajax-product-filter'),
  value: 'slide_out_panel_on_desktop'
}, {
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Slide-out panel on mobile', 'wc-ajax-product-filter'),
  value: 'slide_out_panel_on_mobile'
}, {
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Slide-out panel on both', 'wc-ajax-product-filter'),
  value: 'slide_out_panel_on_both'
}];
function formVisibilityOptions() {
  const freeOptions = [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Always display', 'wc-ajax-product-filter'),
    value: 'always_display'
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Click button on desktop', 'wc-ajax-product-filter'),
    value: 'click_button_on_desktop'
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Click button on mobile', 'wc-ajax-product-filter'),
    value: 'click_button_on_mobile'
  }, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Click button on both', 'wc-ajax-product-filter'),
    value: 'click_button_on_both'
  }];
  return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.mergeSelectOptions)(freeOptions, proVisibilityOptions, true);
}
