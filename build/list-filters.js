...
const GeneralFields = _ref => {
  ...
  const filterKeyField = () => {
    if ('active-filters' !== filterType && 'reset-button' !== filterType) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Field_Text__WEBPACK_IMPORTED_MODULE_5__["default"], {
        ...
        description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('The unique key that will be used to identify the filter. Only a-z, 0-9, "_" and "-" symbols are supported.', 'wc-ajax-product-filter'),
        value: field_key,
  ...
  if (filterType) {
    output = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, taxonomyField(), postMetaField(), filterKeyField(), valueTypeField(), valueIsDecimalField(), decimalPlacesField());
  }
  ...
  const nextButton = () => {
    ...
    if (1 === step || 3 === totalSteps && 2 === step) {
      ...
      if (1 === step) {
        ...
        if (!filterType || (0,_utils__WEBPACK_IMPORTED_MODULE_5__.tryingProFilterType)(filterType)) {
          disabled = true;
        }
      }
...
const AddNewModal = _ref => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const filtersWithoutOptions = ['search', 'active-filters', 'reset-button'];
