...
const Listbox = () => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    setOptions((0,_utils__WEBPACK_IMPORTED_MODULE_4__.prepareMetaKeys)(meta_keys));
  }, [meta_keys]);

  const handleSetFocus = _ref => {
    let {
      value
    } = _ref;
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, options.map((option, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: `listbox-${option.value}-${index}`,
    className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('__item', {
      active: option.active
    }),
    tabIndex: 0,
    onClick: () => handleSetFocus(option)
...
const GeneralFields = _ref => {
  ...
  const taxonomyField = () => {
    if ('custom-taxonomy' === filterType || 'attribute' === filterType) {
      ...
      const _values = (0,lodash__WEBPACK_IMPORTED_MODULE_4__.find)(options, {
        value: taxonomy
      });
...
/* harmony import */ var _Filter_FilterNav_FilterUI_GeneralFields__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../Filter/FilterNav/FilterUI/GeneralFields */ "./src/components/Filter/FilterNav/FilterUI/GeneralFields.js");
...
const Body = _ref => {
  ...
  if (1 === step) {
    ...
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Field_Listbox__WEBPACK_IMPORTED_MODULE_3__["default"], null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Filter_FilterNav_FilterUI_GeneralFields__WEBPACK_IMPORTED_MODULE_5__["default"], {
      filterType: filterType,
...
const Footer = _ref => {
  ...
  const dots = () => {
    ...
    }), 3 === totalStep && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: classnames__WEBPACK_IMPORTED_MODULE_4___default()({
        active: 3 === step
      })
    }));
...
const AddNewModal = _ref => {
  ...
  const [totalStep, setTotalSteps] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(2);
  return isOpen && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Modal, {
    ...
    className: "__heading"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Add Filter', 'wc-ajax-product-filter')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Body__WEBPACK_IMPORTED_MODULE_4__["default"], {
    step: step,
