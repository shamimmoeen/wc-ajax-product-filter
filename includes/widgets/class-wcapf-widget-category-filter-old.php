...
class WCAPF_Category_Filter_Widget extends WP_Widget
{
	...
	function __construct() {
		parent::__construct(
			...
			__('WC Ajax Product Filter by Category', 'wc-ajax-product-filter'), // Name
			array('description' => __('Filter woocommerce products by category.', 'wc-ajax-product-filter')) // Args
		);
	}
