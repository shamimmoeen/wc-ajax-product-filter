	...
	class WCAPF_Attribute_Filter_Widget extends WP_Widget {
		...
		function __construct() {
			parent::__construct(
				...
				__( 'WC Ajax Product Filter by Attribute', 'wc-ajax-product-filter' ), // Name
				array( 'description' => __( 'Filter woocommerce products by attribute.', 'wc-ajax-product-filter' ) ), // Args
			);
		}
		...
		public function form( $instance ) {
			?>
			<p>
				<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php printf( __( 'Title:', 'wc-ajax-product-filter' ) ); ?></label>
			...
			<p>
				...
				if ( sizeof( $attribute_taxonomies ) > 0 ) {
					?>
					<label for="<?php echo $this->get_field_id( 'attr_name' ); ?>"><?php printf( __( 'Attribute', 'wc-ajax-product-filter' ) ); ?></label>
					<select class="widefat" id="<?php echo $this->get_field_id( 'attr_name' ); ?>"
							name="<?php echo $this->get_field_name( 'attr_name' ); ?>">
						<?php
					...
					printf( __( 'No attribute found!', 'wc-ajax-product-filter' ) );
				}
				?>
			</p>
			<p>
				...
				<select class="widefat" id="<?php echo $this->get_field_id( 'display_type' ); ?>"
					...
					<option value="list" <?php echo( ( ! empty( $instance['display_type'] ) && $instance['display_type'] === 'list' ) ? 'selected="selected"' : '' ); ?>><?php printf( __( 'List', 'wc-ajax-product-filter' ) ); ?></option>
					<option value="dropdown" <?php echo( ( ! empty( $instance['display_type'] ) && $instance['display_type'] === 'dropdown' ) ? 'selected="selected"' : '' ); ?>><?php printf( __( 'Dropdown', 'wc-ajax-product-filter' ) ); ?></option>
				</select>
			</p>
			<p>
				...
				<select class="widefat" id="<?php echo $this->get_field_id( 'query_type' ); ?>"
					...
					<option value="and" <?php echo( ( ! empty( $instance['query_type'] ) && $instance['query_type'] === 'and' ) ? 'selected="selected"' : '' ); ?>><?php printf( __( 'AND', 'wc-ajax-product-filter' ) ); ?></option>
					<option value="or" <?php echo( ( ! empty( $instance['query_type'] ) && $instance['query_type'] === 'or' ) ? 'selected="selected"' : '' ); ?>><?php printf( __( 'OR', 'wc-ajax-product-filter' ) ); ?></option>
				</select>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id( 'enable_multiple' ); ?>"
					   name="<?php echo $this->get_field_name( 'enable_multiple' ); ?>" type="checkbox"
					   value="1" <?php echo ( ! empty( $instance['enable_multiple'] ) && $instance['enable_multiple'] == true ) ? 'checked="checked"' : ''; ?>>
				<label for="<?php echo $this->get_field_id( 'enable_multiple' ); ?>"><?php printf( __( 'Enable multiple filter', 'wc-ajax-product-filter' ) ); ?></label>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id( 'show_count' ); ?>"
					   name="<?php echo $this->get_field_name( 'show_count' ); ?>" type="checkbox"
					   value="1" <?php echo ( ! empty( $instance['show_count'] ) && $instance['show_count'] == true ) ? 'checked="checked"' : ''; ?>>
				<label for="<?php echo $this->get_field_id( 'show_count' ); ?>"><?php printf( __( 'Show count', 'wc-ajax-product-filter' ) ); ?></label>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id( 'hierarchical' ); ?>"
					   name="<?php echo $this->get_field_name( 'hierarchical' ); ?>" type="checkbox"
					   value="1" <?php echo ( ! empty( $instance['hierarchical'] ) && $instance['hierarchical'] == true ) ? 'checked="checked"' : ''; ?>>
				<label for="<?php echo $this->get_field_id( 'hierarchical' ); ?>"><?php printf( __( 'Show hierarchy', 'wc-ajax-product-filter' ) ); ?></label>
			</p>
			<p>
				<input id="<?php echo $this->get_field_id( 'show_children_only' ); ?>"
					   name="<?php echo $this->get_field_name( 'show_children_only' ); ?>" type="checkbox"
					   value="1" <?php echo ( ! empty( $instance['show_children_only'] ) && $instance['show_children_only'] == true ) ? 'checked="checked"' : ''; ?>>
				<label for="<?php echo $this->get_field_id( 'show_children_only' ); ?>"><?php printf( __( 'Only show children of the current attribute', 'wc-ajax-product-filter' ) ); ?></label>
			</p>
			<?php
		}
